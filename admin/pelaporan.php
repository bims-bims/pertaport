...
<?php
include '../koneksi.php'; // Sesuaikan dengan path ke file koneksi.php Anda

// Query untuk menghitung jumlah laporan yang menunggu konfirmasi
$query = "SELECT COUNT(*) AS totalMenungguKonfirmasi FROM tbl_pelaporan WHERE status = 'Menunggu Konfirmasi'";
$result = mysqli_query($koneksi, $query);
$data = mysqli_fetch_assoc($result);
$totalMenungguKonfirmasi = $data['totalMenungguKonfirmasi'];
?>
                <div class=" card mb-4">
                <div class="card-header">
                    <a type="button" href="pelaporan_menunggu.php" id="show-pending-reports" class="btn btn-danger">Menunggu Konfirmasi <?php echo $totalMenungguKonfirmasi; ?></a>
                ...
                <div class="card-body">
                    ...
                    <thead>
                            ...
                            <?php
                                    ...
                                    // Mengambil data dengan urutan descending berdasarkan timestamp
    ...
    if ( $status == 'Selesai Terkonfirmasi') {
        if ($status == 'Selesai Terkonfirmasi') {
            ...
            echo '<button type="button" class="btn btn-warning" disabled>Laporan sudah diterima</button>';
        }
    } else {
...
<div class="modal fade" id="edit<?= $d['pelaporan_id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="form-group mt-2 mb-2">
        ...
        <textarea class="form-control" class="laporan" name="laporan" Readonly ><?php echo isset($d['laporan']) ? $d['laporan'] : ''; ?></textarea>
    </div>
    <div class="form-group mt-2 mb-2">
